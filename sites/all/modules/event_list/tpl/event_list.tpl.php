...
<!--                    <span class="month">--><?php //echo date('F', $node->field_event_start_time[LANGUAGE_NONE][0]['value']); ?><!--</span>-->
<!--                    <span class="day">--><?php //echo date('d', $node->field_event_start_time[LANGUAGE_NONE][0]['value']); ?><!--</span>-->
<!--                    <span class="year">--><?php //echo date('Y', $node->field_event_start_time[LANGUAGE_NONE][0]['value']); ?>
<!--                </span>-->
<!--                </div>-->
<!--            </div>-->
